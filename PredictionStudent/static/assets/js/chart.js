$(function () {
  ...
  // };
  var data = {
    labels: ["Random Forest", "Linear Regression", "Decision Tree"],
    datasets: [{
      label: '# Accuracy',
      data: [1.0, 0.97241 , 1.0],
      backgroundColor: [
        'rgba(255, 99, 132, 0.2)',
        'rgba(54, 162, 235, 0.2)',
        'rgba(255, 206, 86, 0.2)'
  ...
  var confusionMatrixData = {
    ...
    datasets: [{
      ...
      data: [[143, 2], [1, 65]], // Isi data sesuai dengan confusion matrix yang ingin ditampilkan
      backgroundColor: [
        'rgba(255, 99, 132, 0.5)',
        'rgba(54, 162, 235, 0.5)',
      ],
